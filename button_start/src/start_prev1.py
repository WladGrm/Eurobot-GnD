...
def poehali_green(kyda):
	...
	if kyda == "start":
		...
		gr = moveToGoal(xStart, yStart, -theta30)
	elif kyda == "cake_y":
		gr = moveToGoal(0, Ly, -theta30)
	elif kyda == "cake_r_preapproach":
		gr = moveToGoal(0, Ly, -theta150)
	elif kyda == "cake_r":
		gr = moveToGoal(0, Ly+Lr, -theta150)
	return gr
...
def delo(type):
	...
	if type == "cake_b":
		...
		a = [45, 160, 10, 140, 100, 95, 512, 512, 512]
		angle.data = a
