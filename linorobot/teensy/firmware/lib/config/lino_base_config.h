...
#define K_I 0.3//0.3 // I constant
#define K_D 0.5 //0.5 // D constant

//define your robot' specs here
#define MAX_RPM 165               // motor's maximum RPM
#define COUNTS_PER_REV 1700       // wheel encoder's no of ticks per rev
#define WHEEL_DIAMETER 0.058       // wheel's diameter in meters
#define PWM_BITS 8                // PWM Resolution of the microcontroller
#define LR_WHEELS_DISTANCE 0.177  // distance between left and right wheels
#define FR_WHEELS_DISTANCE 0.00   // distance between front and rear wheels. Ignore this if you're on 2WD/ACKERMANN
...
ROBOT ORIENTATION
    ...
    MOTOR3  MOTOR4 #ifdef USE_BTS7960_DRIVER
  ...
  #define MOTOR4_IN_B 3 (4WD/MECANUM)  
         BACK
*/

/// ENCODER PINS
#define MOTOR1_ENCODER_A 37
...
//#define MOTOR4_ENCODER_A 2 //PIN 2 = NOT USE
...
//  #define MOTOR4_PWM 2 //PIN 2 = NOT USE
